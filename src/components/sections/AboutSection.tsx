          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-[var(--color-foreground)] leading-relaxed mb-8">
                BLESS FOURCHETTE est bien plus qu'un service de repas—c'est une communauté 
                fondée sur la foi, la générosité et le partage. Nous croyons que nourrir le 
                corps et l'âme va de pair, et que chaque repas est une opportunité de créer 
                des liens et de servir avec amour.
              </p>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-[var(--color-accent)]/10 to-[var(--color-primary)]/10 p-8 rounded-2xl border-l-4 border-[var(--color-accent)]">
              ...
              <blockquote className="relative z-10">
                <p className="text-2xl md:text-3xl font-serif italic text-[var(--color-secondary)] leading-relaxed mb-4">
                  ...
                  et qui est à la surface de toute la terre, et tout arbre ayant en lui 
                  du fruit d'arbre et portant de la semence: ce sera votre nourriture."
                </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              <p className="text-xl text-[var(--color-muted-foreground)] leading-relaxed">
                Une partie de chaque dollar que vous dépensez soutient activement la lutte 
                contre l'anémie falciforme. Nous sommes fiers de contribuer à la recherche 
                médicale, au soutien des patients et aux programmes de sensibilisation.
              </p>
              
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
                <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                  <h4 className="font-bold text-[var(--color-secondary)] mb-2">Recherche</h4>
                  <p className="text-sm text-[var(--color-muted-foreground)]">Financement d'études innovantes</p>
                </div>
                
                <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                  <h4 className="font-bold text-[var(--color-secondary)] mb-2">Soutien</h4>
                  <p className="text-sm text-[var(--color-muted-foreground)]">Aide aux patients et familles</p>
                </div>
                
                <div className="text-center p-6 bg-white rounded-xl shadow-sm">
                  <h4 className="font-bold text-[var(--color-secondary)] mb-2">Sensibilisation</h4>
                  <p className="text-sm text-[var(--color-muted-foreground)]">Éducation et prévention</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-[var(--color-foreground)] leading-relaxed">
              Notre passion pour la santé holistique et la foi guide chaque aspect de 
              BLESS FOURCHETTE. Soutenir la lutte contre l'anémie falciforme n'est pas 
              seulement une mission d'entreprise, C'est un appel du cœur, une conviction 
              profonde que nous pouvons faire une différence dans la vie des autres.
            </p>
            ...
            <div className="bg-gradient-to-r from-[var(--color-primary)]/10 to-[var(--color-accent)]/10 p-6 rounded-xl border-l-4 border-[var(--color-primary)]">
              <p className="text-lg italic text-[var(--color-secondary)] font-medium">
                "Chaque repas que nous préparons, chaque famille que nous servons, 
                chaque dollar que nous reversons—tout cela fait partie d'un dessein 
                plus grand pour nourrir notre communauté et guérir notre monde."
              </p>
            </div>
          </div>
